...
fn print_welcome_message() {
    ...
    println!();
    println!("In addition to mail, you may also receive scheduled action requests.");
    println!("The human team members can set up CRON schedules that automatically");
    println!("trigger you at specific times (e.g., every morning at 9am, or every");
    println!("5 minutes). When a schedule fires, you'll receive a notification just");
    println!("like mail, and you should process the scheduled action request.");
    println!();
    println!("    Example: A daily report schedule might trigger you each morning");
    println!("    to generate and email a summary of yesterday's activities.");
    println!();
    println!("You can view and manage your schedules through the web interface");
    println!("at /agents/{{your-id}}/schedule, or the human can use the CLI.");
    println!();
